...
(function() {
    ...
    const translations = {
        pt: {
            ...
            pbc_throughput_title: 'Process Behavior Chart · Throughput',
            pbc_lead_time_title: 'Process Behavior Chart · Lead Time',
            pbc_generic_description: 'Calculamos média e limites de controle (UCL/LCL) com o método Moving Range (MR) para monitorar a estabilidade.',
            pbc_mr_badge: 'Método MR',
            pbc_mr_hint: 'Moving Range (MR) aproxima a variação natural acompanhando a diferença média absoluta entre observações consecutivas.',
            pbc_stat_mean_label: 'Média do processo',
            pbc_stat_ucl_label: 'Limite superior (UCL)',
            pbc_stat_lcl_label: 'Limite inferior (LCL)',
            pbc_stat_mr_label: 'MR médio',
            pbc_stat_mean_hint: 'Centro esperado se o processo permanecer sob controle estatístico.',
            pbc_stat_limit_hint: 'Limites de controle = média ± 2,66 × MR (≈3 sigma).',
            pbc_stat_mr_hint: 'Média do Moving Range entre observações consecutivas, usada como proxy de ruído.',
            pbc_empty_message: 'Forneça pelo menos 4 amostras para gerar o Process Behavior Chart.',
            pbc_special_causes_label: 'Sinais especiais',
            pbc_special_causes_none: 'Nenhum sinal especial detectado. Processo está sob controle estatístico.',
            pbc_special_causes_points: '{{count}} ponto(s) além dos limites de controle.',
            pbc_special_causes_runs: '{{count}} sequência(s) sustentada(s) (8+ pontos de um lado).',
            pbc_legend_baseline: 'Linha média e limites UCL/LCL',
            pbc_legend_point: 'Pontos dentro do controle',
            pbc_legend_special: 'Pontos fora de controle',
            pbc_legend_run: 'Pontos em sequência longa',
            pbc_sample_count: '{{count}} observações analisadas.',
            pbc_education_title: 'Como interpretar Process Behavior Charts',
            pbc_education_intro: 'Use estes gráficos para separar variação comum (ruído) de causas especiais que exigem ação.',
            pbc_education_item_limits: 'Pontos além dos limites quase sempre indicam causa especial — investigue imediatamente.',
            pbc_education_item_runs: 'Oito ou mais pontos do mesmo lado da média indicam mudança sustentada no processo.',
            pbc_education_item_react: 'Reaja apenas aos sinais especiais; intervir no ruído comum aumenta a variabilidade.',
        ...
        en: {
            ...
            pbc_throughput_title: 'Process Behavior Chart · Throughput',
            pbc_lead_time_title: 'Process Behavior Chart · Lead Time',
            pbc_generic_description: 'We calculate mean and statistical control limits (UCL/LCL) using the Moving Range (MR) method to monitor stability.',
            pbc_mr_badge: 'MR Method',
            pbc_mr_hint: 'Moving Range (MR) approximates natural variation by tracking the average absolute difference between consecutive observations.',
            pbc_stat_mean_label: 'Process mean',
            pbc_stat_ucl_label: 'Upper control limit (UCL)',
            pbc_stat_lcl_label: 'Lower control limit (LCL)',
            pbc_stat_mr_label: 'Average MR',
            pbc_stat_mean_hint: 'Expected center if the process stays under statistical control.',
            pbc_stat_limit_hint: 'Control limits = mean ± 2.66 × MR (≈3 sigma).',
            pbc_stat_mr_hint: 'Average moving range between consecutive observations, used as a proxy for noise.',
            pbc_empty_message: 'Provide at least 4 samples to plot the Process Behavior Chart.',
            pbc_special_causes_label: 'Special cause signals',
            pbc_special_causes_none: 'No special causes detected. The process is in statistical control.',
            pbc_special_causes_points: '{{count}} point(s) beyond the control limits.',
            pbc_special_causes_runs: '{{count}} sustained run(s) (8+ points on one side).',
            pbc_legend_baseline: 'Mean line and UCL/LCL limits',
            pbc_legend_point: 'Points within control',
            pbc_legend_special: 'Out-of-control points',
            pbc_legend_run: 'Points inside long runs',
            pbc_sample_count: '{{count}} observations analyzed.',
            pbc_education_title: 'How to interpret Process Behavior Charts',
            pbc_education_intro: 'Use these charts to separate common-cause variation (noise) from special causes that require action.',
            pbc_education_item_limits: 'Points beyond UCL/LCL almost always indicate a special cause worth immediate investigation.',
            pbc_education_item_runs: 'Eight or more points on the same side of the mean signal a meaningful process shift.',
            pbc_education_item_react: 'React only to special causes—tampering with common-cause noise increases variability.',
        ...
        es: {
            ...
            // Process Behavior Charts
            pbc_throughput_title: 'Process Behavior Chart · Rendimiento',
            pbc_lead_time_title: 'Process Behavior Chart · Lead Time',
            pbc_generic_description: 'Calculamos la media y los límites de control (UCL/LCL) con el método Moving Range (MR) para monitorear la estabilidad.',
            pbc_mr_badge: 'Método MR',
            pbc_mr_hint: 'Moving Range (MR) aproxima la variación natural midiendo la diferencia media absoluta entre observaciones consecutivas.',
            pbc_stat_mean_label: 'Media del proceso',
            pbc_stat_ucl_label: 'Límite superior (UCL)',
            pbc_stat_lcl_label: 'Límite inferior (LCL)',
            pbc_stat_mr_label: 'MR promedio',
            pbc_stat_mean_hint: 'Centro esperado si el proceso permanece bajo control estadístico.',
            pbc_stat_limit_hint: 'Límites de control = media ± 2,66 × MR (≈3 sigma).',
            pbc_stat_mr_hint: 'Promedio del Moving Range entre observaciones consecutivas, usado como proxy del ruido.',
            pbc_empty_message: 'Proporcione al menos 4 muestras para dibujar el Process Behavior Chart.',
            pbc_special_causes_label: 'Señales especiales',
            pbc_special_causes_none: 'No se detectaron señales especiales. El proceso está bajo control estadístico.',
            pbc_special_causes_points: '{{count}} punto(s) fuera de los límites de control.',
            pbc_special_causes_runs: '{{count}} secuencia(s) sostenida(s) (8+ puntos del mismo lado).',
            pbc_legend_baseline: 'Línea de media y límites UCL/LCL',
            pbc_legend_point: 'Puntos dentro del control',
            pbc_legend_special: 'Puntos fuera de control',
            pbc_legend_run: 'Puntos en secuencias largas',
            pbc_sample_count: '{{count}} observaciones analizadas.',
            pbc_education_title: 'Cómo interpretar los Process Behavior Charts',
            pbc_education_intro: 'Use estos gráficos para separar la variación común (ruido) de las causas especiales que requieren acción.',
            pbc_education_item_limits: 'Los puntos fuera de UCL/LCL casi siempre indican una causa especial que debe investigarse de inmediato.',
            pbc_education_item_runs: 'Ocho o más puntos del mismo lado de la media indican un cambio significativo en el proceso.',
            pbc_education_item_react: 'Reaccione solo ante señales especiales; intervenir en el ruido común aumenta la variabilidad.',
